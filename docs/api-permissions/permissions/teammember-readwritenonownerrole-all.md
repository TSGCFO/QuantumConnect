...
Connect-MgGraph -Scopes "TeamMember.ReadWriteNonOwnerRole.All"
...
Other permissions in the `TeamMember` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: TeamMember
