...
Connect-MgGraph -Scopes "CallRecordings.Read.All"
...
Other permissions in the `CallRecordings` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: CallRecordings
