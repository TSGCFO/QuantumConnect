...
Other permissions in the `DelegatedAdminRelationship` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: DelegatedAdminRelationship
