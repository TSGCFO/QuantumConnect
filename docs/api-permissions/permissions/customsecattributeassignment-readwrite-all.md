...
Other permissions in the `CustomSecAttributeAssignment` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: CustomSecAttributeAssignment
