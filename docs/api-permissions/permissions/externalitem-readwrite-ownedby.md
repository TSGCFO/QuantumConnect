...
Connect-MgGraph -Scopes "ExternalItem.ReadWrite.OwnedBy"
...
Other permissions in the `ExternalItem` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ExternalItem
