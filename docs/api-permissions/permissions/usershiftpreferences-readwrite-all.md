...
Connect-MgGraph -Scopes "UserShiftPreferences.ReadWrite.All"
...
Other permissions in the `UserShiftPreferences` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: UserShiftPreferences
