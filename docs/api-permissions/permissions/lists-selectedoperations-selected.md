...
Connect-MgGraph -Scopes "Lists.SelectedOperations.Selected"
...
Other permissions in the `Lists` family may include read-only versions, write versions, or more specific scopes:
