...
- **Display Name**: Access selected file storage container type registrations
- **Permission ID**: `2dcc6599-bd30-442b-8f11-90f88ad441dc`
...
Other permissions in the `FileStorageContainerTypeReg` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: FileStorageContainerTypeReg
