...
Connect-MgGraph -Scopes "UserNotification.ReadWrite.CreatedByApp"
...
Other permissions in the `UserNotification` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: UserNotification
