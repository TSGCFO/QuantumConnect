...
Connect-MgGraph -Scopes "CallDelegation.ReadWrite.All"
...
Other permissions in the `CallDelegation` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: CallDelegation
