...
Other permissions in the `NetworkAccessPolicy` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: NetworkAccessPolicy
