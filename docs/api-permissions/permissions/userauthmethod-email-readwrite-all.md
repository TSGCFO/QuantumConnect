...
Connect-MgGraph -Scopes "UserAuthMethod-Email.ReadWrite.All"
...
Other permissions in the `UserAuthMethod` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: UserAuthMethod-Email
