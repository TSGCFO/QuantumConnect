...
Connect-MgGraph -Scopes "CustomDetection.ReadWrite.All"
...
Other permissions in the `CustomDetection` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: CustomDetection
