...
Connect-MgGraph -Scopes "Insights-UserMetric.Read.All"
...
Other permissions in the `Insights` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: Insights-UserMetric
