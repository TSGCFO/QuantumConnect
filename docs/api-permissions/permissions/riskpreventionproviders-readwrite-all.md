...
Connect-MgGraph -Scopes "RiskPreventionProviders.ReadWrite.All"
...
Other permissions in the `RiskPreventionProviders` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: RiskPreventionProviders
