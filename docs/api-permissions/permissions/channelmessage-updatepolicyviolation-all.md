...
Connect-MgGraph -Scopes "ChannelMessage.UpdatePolicyViolation.All"
...
Other permissions in the `ChannelMessage` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ChannelMessage
