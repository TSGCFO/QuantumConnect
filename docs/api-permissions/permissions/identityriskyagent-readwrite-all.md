...
Connect-MgGraph -Scopes "IdentityRiskyAgent.ReadWrite.All"
...
Other permissions in the `IdentityRiskyAgent` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: IdentityRiskyAgent
