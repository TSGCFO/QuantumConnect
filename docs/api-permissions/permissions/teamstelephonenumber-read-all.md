...
Connect-MgGraph -Scopes "TeamsTelephoneNumber.Read.All"
...
Other permissions in the `TeamsTelephoneNumber` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: TeamsTelephoneNumber
