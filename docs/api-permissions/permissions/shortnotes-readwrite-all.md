...
Connect-MgGraph -Scopes "ShortNotes.ReadWrite.All"
...
Other permissions in the `ShortNotes` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ShortNotes
