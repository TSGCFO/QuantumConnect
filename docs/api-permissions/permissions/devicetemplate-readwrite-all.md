...
Connect-MgGraph -Scopes "DeviceTemplate.ReadWrite.All"
...
Other permissions in the `DeviceTemplate` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: DeviceTemplate
