...
Other permissions in the `SharePointTenantSettings` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: SharePointTenantSettings
