...
Connect-MgGraph -Scopes "ContentActivity.Read"
...
Other permissions in the `ContentActivity` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ContentActivity
