...
Connect-MgGraph -Scopes "Presence.ReadWrite.All"
...
Other permissions in the `Presence` family may include read-only versions, write versions, or more specific scopes:
