...
Connect-MgGraph -Scopes "FileIngestionHybridOnboarding.Manage"
...
Other permissions in the `FileIngestionHybridOnboarding` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: FileIngestionHybridOnboarding
