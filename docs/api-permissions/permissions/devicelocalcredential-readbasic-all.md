...
Other permissions in the `DeviceLocalCredential` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: DeviceLocalCredential
