...
Connect-MgGraph -Scopes "ResourceSpecificPermissionGrant.ReadForChat.All"
...
Other permissions in the `ResourceSpecificPermissionGrant` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ResourceSpecificPermissionGrant
