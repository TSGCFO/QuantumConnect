...
Other permissions in the `SignInIdentifier` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: SignInIdentifier
