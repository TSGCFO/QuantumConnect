...
Connect-MgGraph -Scopes "IndustryData-Run.Start"
...
Other permissions in the `IndustryData` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: IndustryData-Run
