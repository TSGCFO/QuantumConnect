...
Other permissions in the `SpiffeTrustDomain` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: SpiffeTrustDomain
