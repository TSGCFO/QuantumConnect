...
Connect-MgGraph -Scopes "User-ConvertToInternal.ReadWrite.All"
...
Other permissions in the `User` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: User-ConvertToInternal
