...
Other permissions in the `MultiTenantOrganization` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: MultiTenantOrganization
