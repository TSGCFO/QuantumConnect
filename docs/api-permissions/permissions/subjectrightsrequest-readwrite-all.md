...
Connect-MgGraph -Scopes "SubjectRightsRequest.ReadWrite.All"
...
Other permissions in the `SubjectRightsRequest` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: SubjectRightsRequest
