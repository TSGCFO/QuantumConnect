...
Connect-MgGraph -Scopes "RoleManagement.Read.Defender"
...
Other permissions in the `RoleManagement` family may include read-only versions, write versions, or more specific scopes:
