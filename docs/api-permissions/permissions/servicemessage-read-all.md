...
Other permissions in the `ServiceMessage` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ServiceMessage
