...
Connect-MgGraph -Scopes "CallAiInsights.Read.All"
...
Other permissions in the `CallAiInsights` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: CallAiInsights
