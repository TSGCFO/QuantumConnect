...
Other permissions in the `ConfigurationMonitoring` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ConfigurationMonitoring
