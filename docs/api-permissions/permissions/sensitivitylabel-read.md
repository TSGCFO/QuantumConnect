...
Connect-MgGraph -Scopes "SensitivityLabel.Read"
...
Other permissions in the `SensitivityLabel` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: SensitivityLabel
