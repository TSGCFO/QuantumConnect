...
Connect-MgGraph -Scopes "CallEvents-Emergency.Read.All"
...
Other permissions in the `CallEvents` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: CallEvents-Emergency
