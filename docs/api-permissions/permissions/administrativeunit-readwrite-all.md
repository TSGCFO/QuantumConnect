...
Other permissions in the `AdministrativeUnit` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: AdministrativeUnit
