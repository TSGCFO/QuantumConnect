...
Connect-MgGraph -Scopes "AiEnterpriseInteraction.Read.All"
...
Other permissions in the `AiEnterpriseInteraction` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: AiEnterpriseInteraction
