...
Other permissions in the `DeviceManagementScripts` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: DeviceManagementScripts
