...
Connect-MgGraph -Scopes "BrowserSiteLists.ReadWrite.All"
...
Other permissions in the `BrowserSiteLists` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: BrowserSiteLists
