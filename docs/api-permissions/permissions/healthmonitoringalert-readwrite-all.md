...
Connect-MgGraph -Scopes "HealthMonitoringAlert.ReadWrite.All"
...
Other permissions in the `HealthMonitoringAlert` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: HealthMonitoringAlert
