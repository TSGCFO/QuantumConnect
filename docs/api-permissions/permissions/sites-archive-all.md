...
Connect-MgGraph -Scopes "Sites.Archive.All"
...
Other permissions in the `Sites` family may include read-only versions, write versions, or more specific scopes:
