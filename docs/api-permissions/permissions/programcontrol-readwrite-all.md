...
Connect-MgGraph -Scopes "ProgramControl.ReadWrite.All"
...
Other permissions in the `ProgramControl` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ProgramControl
