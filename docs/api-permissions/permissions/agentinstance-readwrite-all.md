...
Connect-MgGraph -Scopes "AgentInstance.ReadWrite.All"
...
Other permissions in the `AgentInstance` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: AgentInstance
