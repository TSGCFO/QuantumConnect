...
Connect-MgGraph -Scopes "OnlineMeetings.ReadWrite.All"
...
Other permissions in the `OnlineMeetings` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: OnlineMeetings
