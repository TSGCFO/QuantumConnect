...
Other permissions in the `DeviceManagementManagedDevices` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: DeviceManagementManagedDevices
