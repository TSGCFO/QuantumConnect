...
Connect-MgGraph -Scopes "SensitivityLabels.Read.All"
...
Other permissions in the `SensitivityLabels` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: SensitivityLabels
