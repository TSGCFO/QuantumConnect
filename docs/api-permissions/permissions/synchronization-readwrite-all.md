...
Other permissions in the `Synchronization` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: Synchronization
