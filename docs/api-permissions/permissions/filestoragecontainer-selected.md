...
Other permissions in the `FileStorageContainer` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: FileStorageContainer
