...
Connect-MgGraph -Scopes "UserTeamwork.Read.All"
...
Other permissions in the `UserTeamwork` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: UserTeamwork
