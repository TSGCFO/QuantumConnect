...
Connect-MgGraph -Scopes "CustomSecAttributeAuditLogs.Read.All"
...
Other permissions in the `CustomSecAttributeAuditLogs` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: CustomSecAttributeAuditLogs
