...
Other permissions in the `PrivilegedAccess` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: PrivilegedAccess
