...
Other permissions in the `ChannelSettings` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ChannelSettings
