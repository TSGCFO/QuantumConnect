...
Connect-MgGraph -Scopes "People.Read.All"
...
Other permissions in the `People` family may include read-only versions, write versions, or more specific scopes:
