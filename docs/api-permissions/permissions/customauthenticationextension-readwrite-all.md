...
Connect-MgGraph -Scopes "CustomAuthenticationExtension.ReadWrite.All"
...
Other permissions in the `CustomAuthenticationExtension` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: CustomAuthenticationExtension
