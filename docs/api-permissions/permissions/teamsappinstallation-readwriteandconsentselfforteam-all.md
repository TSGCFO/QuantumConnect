...
Connect-MgGraph -Scopes "TeamsAppInstallation.ReadWriteAndConsentSelfForTeam.All"
...
Other permissions in the `TeamsAppInstallation` family may include read-only versions, write versions, or more specific scopes:
