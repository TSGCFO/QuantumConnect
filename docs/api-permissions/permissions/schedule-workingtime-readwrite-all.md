...
Connect-MgGraph -Scopes "Schedule-WorkingTime.ReadWrite.All"
...
Other permissions in the `Schedule` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: Schedule-WorkingTime
