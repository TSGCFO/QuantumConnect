...
Other permissions in the `TeamworkAppSettings` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: TeamworkAppSettings
