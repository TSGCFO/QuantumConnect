...
Connect-MgGraph -Scopes "ChangeManagement.Read.All"
...
Other permissions in the `ChangeManagement` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ChangeManagement
