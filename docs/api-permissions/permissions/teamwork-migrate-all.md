...
Connect-MgGraph -Scopes "Teamwork.Migrate.All"
...
Other permissions in the `Teamwork` family may include read-only versions, write versions, or more specific scopes:
