...
Connect-MgGraph -Scopes "Policy.ReadWrite.CrossTenantCapability"
...
Other permissions in the `Policy` family may include read-only versions, write versions, or more specific scopes:
