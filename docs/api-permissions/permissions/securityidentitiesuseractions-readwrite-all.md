...
Connect-MgGraph -Scopes "SecurityIdentitiesUserActions.ReadWrite.All"
...
Other permissions in the `SecurityIdentitiesUserActions` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: SecurityIdentitiesUserActions
