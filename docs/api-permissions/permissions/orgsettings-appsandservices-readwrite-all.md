...
Connect-MgGraph -Scopes "OrgSettings-AppsAndServices.ReadWrite.All"
...
Other permissions in the `OrgSettings` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: OrgSettings-AppsAndServices
