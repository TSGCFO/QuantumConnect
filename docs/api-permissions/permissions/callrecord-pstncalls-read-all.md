...
Connect-MgGraph -Scopes "CallRecord-PstnCalls.Read.All"
...
Other permissions in the `CallRecord` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: CallRecord-PstnCalls
