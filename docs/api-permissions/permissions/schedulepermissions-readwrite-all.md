...
Connect-MgGraph -Scopes "SchedulePermissions.ReadWrite.All"
...
Other permissions in the `SchedulePermissions` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: SchedulePermissions
