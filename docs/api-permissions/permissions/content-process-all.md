...
Connect-MgGraph -Scopes "Content.Process.All"
...
Other permissions in the `Content` family may include read-only versions, write versions, or more specific scopes:
