...
Other permissions in the `SecurityIncident` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: SecurityIncident
