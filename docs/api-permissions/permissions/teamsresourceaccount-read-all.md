...
Connect-MgGraph -Scopes "TeamsResourceAccount.Read.All"
...
Other permissions in the `TeamsResourceAccount` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: TeamsResourceAccount
