...
Connect-MgGraph -Scopes "QnA.Read.All"
...
Other permissions in the `QnA` family may include read-only versions, write versions, or more specific scopes:
