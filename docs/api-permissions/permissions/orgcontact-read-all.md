...
Connect-MgGraph -Scopes "OrgContact.Read.All"
...
Other permissions in the `OrgContact` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: OrgContact
