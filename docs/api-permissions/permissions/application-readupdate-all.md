...
Connect-MgGraph -Scopes "Application.ReadUpdate.All"
...
Other permissions in the `Application` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: Application
