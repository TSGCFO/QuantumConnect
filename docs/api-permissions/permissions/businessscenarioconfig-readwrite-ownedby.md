...
Connect-MgGraph -Scopes "BusinessScenarioConfig.ReadWrite.OwnedBy"
...
Other permissions in the `BusinessScenarioConfig` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: BusinessScenarioConfig
