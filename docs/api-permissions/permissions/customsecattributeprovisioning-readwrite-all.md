...
Connect-MgGraph -Scopes "CustomSecAttributeProvisioning.ReadWrite.All"
...
Other permissions in the `CustomSecAttributeProvisioning` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: CustomSecAttributeProvisioning
