...
Connect-MgGraph -Scopes "AuditLogsQuery-OneDrive.Read.All"
...
Other permissions in the `AuditLogsQuery` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: AuditLogsQuery-OneDrive
