...
Connect-MgGraph -Scopes "ServiceActivity-OneDrive.Read.All"
...
Other permissions in the `ServiceActivity` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ServiceActivity-OneDrive
