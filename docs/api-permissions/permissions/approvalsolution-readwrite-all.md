...
Connect-MgGraph -Scopes "ApprovalSolution.ReadWrite.All"
...
Other permissions in the `ApprovalSolution` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ApprovalSolution
