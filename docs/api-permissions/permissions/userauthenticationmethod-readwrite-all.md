...
Other permissions in the `UserAuthenticationMethod` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: UserAuthenticationMethod
