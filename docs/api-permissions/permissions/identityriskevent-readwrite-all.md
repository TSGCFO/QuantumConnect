...
Other permissions in the `IdentityRiskEvent` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: IdentityRiskEvent
