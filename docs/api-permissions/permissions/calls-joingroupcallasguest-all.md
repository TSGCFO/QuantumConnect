...
Connect-MgGraph -Scopes "Calls.JoinGroupCallAsGuest.All"
...
Other permissions in the `Calls` family may include read-only versions, write versions, or more specific scopes:
