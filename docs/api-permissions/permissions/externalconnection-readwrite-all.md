...
Connect-MgGraph -Scopes "ExternalConnection.ReadWrite.All"
...
Other permissions in the `ExternalConnection` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ExternalConnection
