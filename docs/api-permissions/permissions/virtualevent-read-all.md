...
Connect-MgGraph -Scopes "VirtualEvent.Read.All"
...
Other permissions in the `VirtualEvent` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: VirtualEvent
