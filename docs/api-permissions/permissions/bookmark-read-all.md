...
Connect-MgGraph -Scopes "Bookmark.Read.All"
...
Other permissions in the `Bookmark` family may include read-only versions, write versions, or more specific scopes:
