...
Connect-MgGraph -Scopes "ListItems.SelectedOperations.Selected"
...
Other permissions in the `ListItems` family may include read-only versions, write versions, or more specific scopes:
