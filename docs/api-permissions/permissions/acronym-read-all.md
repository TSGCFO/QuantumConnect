...
Connect-MgGraph -Scopes "Acronym.Read.All"
...
Other permissions in the `Acronym` family may include read-only versions, write versions, or more specific scopes:
