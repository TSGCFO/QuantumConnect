...
Connect-MgGraph -Scopes "ProtectionScopes.Compute.All"
...
Other permissions in the `ProtectionScopes` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ProtectionScopes
