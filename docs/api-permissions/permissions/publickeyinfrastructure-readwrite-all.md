...
Connect-MgGraph -Scopes "PublicKeyInfrastructure.ReadWrite.All"
...
Other permissions in the `PublicKeyInfrastructure` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: PublicKeyInfrastructure
