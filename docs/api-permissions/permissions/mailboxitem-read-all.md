...
Connect-MgGraph -Scopes "MailboxItem.Read.All"
...
Other permissions in the `MailboxItem` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: MailboxItem
