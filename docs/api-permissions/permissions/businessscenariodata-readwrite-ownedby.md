...
Connect-MgGraph -Scopes "BusinessScenarioData.ReadWrite.OwnedBy"
...
Other permissions in the `BusinessScenarioData` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: BusinessScenarioData
