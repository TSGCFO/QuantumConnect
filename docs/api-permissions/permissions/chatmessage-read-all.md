...
Connect-MgGraph -Scopes "ChatMessage.Read.All"
...
Other permissions in the `ChatMessage` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ChatMessage
