...
Connect-MgGraph -Scopes "AgentCard.ReadWrite.ManagedBy"
...
Other permissions in the `AgentCard` family may include read-only versions, write versions, or more specific scopes:
