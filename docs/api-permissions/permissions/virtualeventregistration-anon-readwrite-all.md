...
Connect-MgGraph -Scopes "VirtualEventRegistration-Anon.ReadWrite.All"
...
Other permissions in the `VirtualEventRegistration` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: VirtualEventRegistration-Anon
