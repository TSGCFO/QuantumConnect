...
Connect-MgGraph -Scopes "AgentCardManifest.ReadWrite.All"
...
Other permissions in the `AgentCardManifest` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: AgentCardManifest
