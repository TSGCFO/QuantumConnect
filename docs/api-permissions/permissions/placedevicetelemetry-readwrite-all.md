...
Connect-MgGraph -Scopes "PlaceDeviceTelemetry.ReadWrite.All"
...
Other permissions in the `PlaceDeviceTelemetry` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: PlaceDeviceTelemetry
