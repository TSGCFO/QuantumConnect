...
Connect-MgGraph -Scopes "BackupRestore-Control.ReadWrite.All"
...
Other permissions in the `BackupRestore` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: BackupRestore-Control
