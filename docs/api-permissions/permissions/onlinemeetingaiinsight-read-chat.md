...
Connect-MgGraph -Scopes "OnlineMeetingAiInsight.Read.Chat"
...
Other permissions in the `OnlineMeetingAiInsight` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: OnlineMeetingAiInsight
