...
Other permissions in the `OnPremisesPublishingProfiles` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: OnPremisesPublishingProfiles
