...
Other permissions in the `DeviceManagementRBAC` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: DeviceManagementRBAC
