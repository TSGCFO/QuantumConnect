...
Connect-MgGraph -Scopes "ChatMember.ReadWrite.WhereInstalled"
...
Other permissions in the `ChatMember` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ChatMember
