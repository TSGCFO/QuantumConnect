...
Connect-MgGraph -Scopes "TeamTemplates.Read.All"
...
Other permissions in the `TeamTemplates` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: TeamTemplates
