...
Other permissions in the `DeviceManagementApps` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: DeviceManagementApps
