...
Connect-MgGraph -Scopes "Group-OnPremisesSyncBehavior.ReadWrite.All"
...
Other permissions in the `Group-OnPremisesSyncBehavior` family:
...
**Permission Category**: Group-OnPremisesSyncBehavior
