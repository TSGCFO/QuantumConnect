...
Connect-MgGraph -Scopes "HealthMonitoringAlertConfig.ReadWrite.All"
...
Other permissions in the `HealthMonitoringAlertConfig` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: HealthMonitoringAlertConfig
