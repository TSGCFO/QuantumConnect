...
Connect-MgGraph -Scopes "MailboxConfigItem.ReadWrite"
...
Other permissions in the `MailboxConfigItem` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: MailboxConfigItem
