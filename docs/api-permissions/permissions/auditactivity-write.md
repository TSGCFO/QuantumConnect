...
Connect-MgGraph -Scopes "AuditActivity.Write"
...
Other permissions in the `AuditActivity` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: AuditActivity
