# UNKNOWN (ID: e2cea78f-e743-4d8f-a16a-75b629a038ae)

## Overview

- **Display Name**: Unknown Permission
- **Permission ID**: `e2cea78f-e743-4d8f-a16a-75b629a038ae`
- **Type**: Application Permission
- **Scope**: Varies
- **Admin Consent Required**: Yes
- **Assigned Date**: 2025-11-23 19:02:07

## Description

Permission not found in current Graph API role definitions
...
Connect-MgGraph -Scopes "UNKNOWN (ID: e2cea78f-e743-4d8f-a16a-75b629a038ae)"
...
Other permissions in the `UNKNOWN` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: UNKNOWN (ID: e2cea78f-e743-4d8f-a16a-75b629a038ae)
