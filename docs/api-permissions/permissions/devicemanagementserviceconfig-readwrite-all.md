...
Other permissions in the `DeviceManagementServiceConfig` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: DeviceManagementServiceConfig
