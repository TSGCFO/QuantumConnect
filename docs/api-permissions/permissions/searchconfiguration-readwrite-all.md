...
Connect-MgGraph -Scopes "SearchConfiguration.ReadWrite.All"
...
Other permissions in the `SearchConfiguration` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: SearchConfiguration
