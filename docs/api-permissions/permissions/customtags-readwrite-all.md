...
Connect-MgGraph -Scopes "CustomTags.ReadWrite.All"
...
Other permissions in the `CustomTags` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: CustomTags
