...
Connect-MgGraph -Scopes "MutualTlsOauthConfiguration.ReadWrite.All"
...
Other permissions in the `MutualTlsOauthConfiguration` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: MutualTlsOauthConfiguration
