...
Connect-MgGraph -Scopes "RoleAssignmentSchedule.Remove.Directory"
...
Other permissions in the `RoleAssignmentSchedule` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: RoleAssignmentSchedule
