...
Connect-MgGraph -Scopes "ConsentRequest.ReadWrite.All"
...
Other permissions in the `ConsentRequest` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ConsentRequest
