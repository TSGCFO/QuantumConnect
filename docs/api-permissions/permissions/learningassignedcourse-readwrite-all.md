...
Connect-MgGraph -Scopes "LearningAssignedCourse.ReadWrite.All"
...
Other permissions in the `LearningAssignedCourse` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: LearningAssignedCourse
