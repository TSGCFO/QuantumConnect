...
Connect-MgGraph -Scopes "TeamsTab.ReadWriteSelfForUser.All"
...
Other permissions in the `TeamsTab` family may include read-only versions, write versions, or more specific scopes:
