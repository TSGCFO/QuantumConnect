...
Connect-MgGraph -Scopes "AgentCollection.ReadWrite.All"
...
Other permissions in the `AgentCollection` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: AgentCollection
