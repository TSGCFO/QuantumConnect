...
Other permissions in the `AuthenticationContext` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: AuthenticationContext
