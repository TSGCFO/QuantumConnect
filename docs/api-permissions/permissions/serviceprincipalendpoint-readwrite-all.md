...
Other permissions in the `ServicePrincipalEndpoint` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: ServicePrincipalEndpoint
