...
Connect-MgGraph -Scopes "FileIngestion.Ingest"
...
Other permissions in the `FileIngestion` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: FileIngestion
