...
Other permissions in the `OnPremDirectorySynchronization` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: OnPremDirectorySynchronization
