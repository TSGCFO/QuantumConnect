...
Connect-MgGraph -Scopes "Member.Read.Hidden"
...
Other permissions in the `Member` family may include read-only versions, write versions, or more specific scopes:
