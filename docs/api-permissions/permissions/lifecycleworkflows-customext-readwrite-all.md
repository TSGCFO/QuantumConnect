...
Connect-MgGraph -Scopes "LifecycleWorkflows-CustomExt.ReadWrite.All"
...
Other permissions in the `LifecycleWorkflows` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: LifecycleWorkflows-CustomExt
