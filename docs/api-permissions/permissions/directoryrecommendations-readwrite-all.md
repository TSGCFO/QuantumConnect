...
Other permissions in the `DirectoryRecommendations` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: DirectoryRecommendations
