...
Connect-MgGraph -Scopes "RoleEligibilitySchedule.Remove.Directory"
...
Other permissions in the `RoleEligibilitySchedule` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: RoleEligibilitySchedule
