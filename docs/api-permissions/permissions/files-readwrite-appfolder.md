...
Connect-MgGraph -Scopes "Files.ReadWrite.AppFolder"
...
Other permissions in the `Files` family may include read-only versions, write versions, or more specific scopes:
