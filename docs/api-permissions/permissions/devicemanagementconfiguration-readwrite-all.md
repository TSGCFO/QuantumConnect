...
Other permissions in the `DeviceManagementConfiguration` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: DeviceManagementConfiguration
