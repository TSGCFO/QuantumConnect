...
Other permissions in the `InformationProtectionPolicy` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: InformationProtectionPolicy
