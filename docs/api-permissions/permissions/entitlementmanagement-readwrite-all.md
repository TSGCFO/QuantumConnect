...
Other permissions in the `EntitlementManagement` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: EntitlementManagement
