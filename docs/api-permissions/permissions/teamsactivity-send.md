...
Connect-MgGraph -Scopes "TeamsActivity.Send"
...
Other permissions in the `TeamsActivity` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: TeamsActivity
