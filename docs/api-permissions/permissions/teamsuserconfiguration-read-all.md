...
Other permissions in the `TeamsUserConfiguration` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: TeamsUserConfiguration
