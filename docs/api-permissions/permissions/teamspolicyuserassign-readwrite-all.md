...
Connect-MgGraph -Scopes "TeamsPolicyUserAssign.ReadWrite.All"
...
Other permissions in the `TeamsPolicyUserAssign` family may include read-only versions, write versions, or more specific scopes:
...
**Permission Category**: TeamsPolicyUserAssign
