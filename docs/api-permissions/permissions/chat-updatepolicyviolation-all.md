...
Connect-MgGraph -Scopes "Chat.UpdatePolicyViolation.All"
...
Other permissions in the `Chat` family may include read-only versions, write versions, or more specific scopes:
